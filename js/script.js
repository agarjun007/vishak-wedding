...
var countDownDate = new Date("Sept 8, 2024 10:00:00").getTime();
...
var x = setInterval(function () {
  ...
  document.getElementById("time").innerHTML = "<span class='place'>" + days + " Days " + hours + " Hours " + minutes + " Minutes " + seconds + " Seconds</span>";
